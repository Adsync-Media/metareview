...
- Head: `9046351faabba691418635bf3eda49e38359b338`
- Branch: `main`
- Gate effect: `gate`

## Context Profile

- Raw diff bytes: `65126`
- Filtered diff bytes: `54609`
- Risk level: `none`
- Generated files excluded: docs/metareview/context/mrv-20260908-053049162286000-artifact-changelog-ab09011f-context.md, docs/metareview/reviews/mrv-20260908-053049162286000-artifact-changelog-ab09011f.md
...
- go test ./cmd/claimcheck-eval/ exited 0
- instruction-text assertion in kind_test.go:590 still passes (substring unchanged)
- e2e: claimcheck-ab 20-claim smoke report byte-identical before and after the refactor
